...
class Awarded : Fragment() {
    private var binding: FragmentAwardedBinding? = null
    private var list: ArrayList<ModelData> = ArrayList()
    private var awardedAdapter: AwardedAdapter? = null
            ...
            val stringRequest: StringRequest = object : StringRequest(
                ...
                Response.Listener { response: String? ->
                    ...
                    try {
                        ...
                        awardedAdapter = AwardedAdapter(activity, list)
                        ...
                        val focusLayoutManager = FocusLayoutManager.Builder()
                            ...
                            .isAutoSelect(true)
                            .maxLayerCount(3)
                            .setOnFocusChangeListener { focusdPosition: Int, lastFocusedPosition: Int -> }
                            .build()
                        binding!!.awardedRecyler.setHasFixedSize(true)
                        binding!!.awardedRecyler.isNestedScrollingEnabled = true
                        binding!!.awardedRecyler.layoutManager = focusLayoutManager
                        binding!!.awardedRecyler.adapter = awardedAdapter
